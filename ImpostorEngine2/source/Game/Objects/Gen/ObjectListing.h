...
#include "AIZ/Act1TreeBark.h"			// 2DD90A2E
...
#include "Common/InvisibleSolid.h"			// C80397C
...
#include "HCZ/HCZ_Miniboss.h"			// 1B9FE404
...
enum {
	...
	Obj_AIZControl = 0x402,
	Obj_AIZMinibossBomb = 0x403,
	Obj_AIZMinibossFlame = 0x404,
	Obj_BloominatorSpore = 0x405,
	Obj_FireBreathBomb = 0x407,
	Obj_FireBreathFlame = 0x408,
	Obj_AIZIntro = 0x409,
	Obj_AIZIntroKnux = 0x40A,
	Obj_AIZIntroSplash = 0x40B,
	Obj_AIZTornado = 0x40C,
	Obj_MonkeyDudeCoconut = 0x40D,
	Obj_BatbrightParts = 0x40F,
	Obj_BlankObject = 0x410,
	Obj_BoundsMarker = 0x411,
	Obj_BubbleAir = 0x412,
	Obj_HUD = 0x414,
	Obj_InvisibleBlockV = 0x415,
	Obj_Music = 0x416,
	Obj_PauseMenu = 0x417,
	Obj_PlaneSwitcher = 0x418,
	Obj_PlatformOutliner = 0x419,
	Obj_PlayerSpawn = 0x41A,
	Obj_TitleCard = 0x41B,
	Obj_WarpStars = 0x41C,
	Obj_EggCapsuleButton = 0x41D,
	Obj_Signpost = 0x41F,
	Obj_TensionBridgeChild = 0x421,
	Obj_ViewCollisionToggler = 0x423,
	Obj_Motobug = 0x424,
	Obj_MotobugSmoke = 0x425,
	Obj_BlastoidShot = 0x426,
	Obj_DepthCharge = 0x428,
	Obj_TurboSpikerSpike = 0x429,
	Obj_SegmentedColumnStub = 0x42A,
	Obj_StarPointerOrbs = 0x42B,
	Obj_SwingingPlatformTrigger = 0x42C,
	Obj_MGZHeadTrigger_Eye = 0x42D,
	Obj_ReliefEye = 0x42E,
	Obj_Platform = 0x42F,
};

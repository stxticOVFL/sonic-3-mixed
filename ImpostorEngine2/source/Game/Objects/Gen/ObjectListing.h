...
enum {
    ...
    Obj_AIZIntro = 0x405,
    Obj_AIZIntroSplash = 0x406,
    Obj_AIZTornado = 0x407,
    Obj_MonkeyDudeCoconut = 0x408,
    Obj_BatbrightParts = 0x409,
    Obj_BlankObject = 0x40A,
    Obj_BoundsMarker = 0x40B,
    Obj_BubbleAir = 0x40C,
    Obj_HUD = 0x40D,
    Obj_InvisibleBlockV = 0x40E,
    Obj_Music = 0x40F,
    Obj_PauseMenu = 0x410,
    Obj_PlaneSwitcher = 0x411,
    Obj_PlatformOutliner = 0x412,
    Obj_PlayerSpawn = 0x413,
    Obj_TitleCard = 0x414,
    Obj_WarpStars = 0x415,
    Obj_EggCapsuleButton = 0x416,
    Obj_Signpost = 0x417,
    Obj_TensionBridgeChild = 0x418,
    Obj_ViewCollisionToggler = 0x419,
    Obj_Motobug = 0x41A,
    Obj_MotobugSmoke = 0x41B,
    Obj_BlastoidShot = 0x41C,
    Obj_DepthCharge = 0x41D,
    Obj_TurboSpikerSpike = 0x41E,
    Obj_SegmentedColumnStub = 0x41F,
    Obj_StarPointerOrbs = 0x420,
    Obj_SwingingPlatformTrigger = 0x421,
    Obj_ReliefEye = 0x422,
    Obj_Platform = 0x423,
};

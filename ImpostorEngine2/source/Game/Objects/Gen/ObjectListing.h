...
#include "AIZ/AIZIntro.h"			// 7B6FD60B
...
enum {
    ...
    Obj_FireBreathBomb = 0x404,
    Obj_FireBreathFlame = 0x405,
    Obj_MonkeyDudeCoconut = 0x406,
    Obj_BatbrightParts = 0x407,
    Obj_BlankObject = 0x408,
    Obj_BoundsMarker = 0x409,
    Obj_BubbleAir = 0x40A,
    Obj_HUD = 0x40B,
    Obj_InvisibleBlockV = 0x40C,
    Obj_Music = 0x40D,
    Obj_PauseMenu = 0x40E,
    Obj_PlaneSwitcher = 0x40F,
    Obj_PlatformOutliner = 0x410,
    Obj_PlayerSpawn = 0x411,
    Obj_TitleCard = 0x412,
    Obj_WarpStars = 0x413,
    Obj_EggCapsuleButton = 0x414,
    Obj_Signpost = 0x415,
    Obj_TensionBridgeChild = 0x416,
    Obj_ViewCollisionToggler = 0x417,
    Obj_Motobug = 0x418,
    Obj_MotobugSmoke = 0x419,
    Obj_BlastoidShot = 0x41A,
    Obj_DepthCharge = 0x41B,
    Obj_TurboSpikerSpike = 0x41C,
    Obj_SegmentedColumnStub = 0x41D,
    Obj_StarPointerOrbs = 0x41E,
    Obj_SwingingPlatformTrigger = 0x41F,
    Obj_ReliefEye = 0x420,
    Obj_Platform = 0x421,
};

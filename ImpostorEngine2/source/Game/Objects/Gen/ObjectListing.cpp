...
int GetObjectIDFromName(const char* ObjName) {
	...
	if (!strcmp(ObjName, "Act1TreeBark")) {
		return 0x9U;
	}
	...
	if (!strcmp(ObjName, "InvisibleSolid")) {
		return 0x28U;
	}
	...
	if (!strcmp(ObjName, "BreakBar")) {
		return 0x36U;
	}

	if (!strcmp(ObjName, "HCZVWaterStream")) {
		return 0x37U;
	}
	...
	if (!strcmp(ObjName, "HCZWaterWall")) {
		return 0x3BU;
	}
	...
	if (!strcmp(ObjName, "HCZConveyorBelt")) {
		return 0x3EU;
	}
	...
	if (!strcmp(ObjName, "HCZConveyorSpike")) {
		return 0x3FU;
	}
	...
	if (!strcmp(ObjName, "MGZHeadTrigger")) {
		return 0x55U;
	}
	...
	if (!strcmp(ObjName, "MGZTriggerPlatform")) {
		return 0x57U;
	}

	if (!strcmp(ObjName, "MGZDashTrigger")) {
		return 0x59U;
	}
	...
	if (!strcmp(ObjName, "HCZSnakeBlocks")) {
		return 0x67U;
	}
	...
	if (!strcmp(ObjName, "HCZWaterSplash")) {
		return 0x6DU;
	}
	...
	if (!strcmp(ObjName, "AIZMinibossCutscene")) {
		return 0x90U;
	}
	...
	if (!strcmp(ObjName, "HCZ_Miniboss")) {
		return 0x99U;
	}
	...
	if (!strcmp(ObjName, "AIZMinibossBomb")) {
		return 0x403U;
	}

	if (!strcmp(ObjName, "AIZMinibossFlame")) {
		return 0x404U;
	}
	...
	if (!strcmp(ObjName, "MGZHeadTrigger_Eye")) {
		return 0x42DU;
	}
	...
	return 0x410U; //Return the BlankObject ID, since the requested one wasn't found

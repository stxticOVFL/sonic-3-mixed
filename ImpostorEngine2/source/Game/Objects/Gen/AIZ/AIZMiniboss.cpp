// Object ID: 0x91
// Object Name: AIZMiniboss.cpp

#include "AIZMiniboss.h"

typedef IMath Math;

void AIZMiniboss::Create() {
    Enemy::Create();
    Active = true;
    Priority = true;
    W = 48;
...
void AIZMiniboss::Render(int CamX, int CamY) {
    if (Cutscene) {

// Object ID: 0x9F
// Object Name: TunnelBot.cpp

#include "TunnelBot.h"

typedef IMath Math;

void TunnelBot::Create() {
    Enemy::Create();
    this->Active = true;
    this->Priority = false;
    this->W = 64;
...
void TunnelBot::DoExplosionDebris() {
...
void TunnelBot::Update() {
    HandleDamage();
    Object::Update();
}

void TunnelBot::Render(int CamX, int CamY) {
...
int TunnelBot::OnCollisionWithPlayer(int PlayerID, int HitFrom, int Data) {

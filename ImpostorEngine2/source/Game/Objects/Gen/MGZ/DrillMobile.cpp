// Object ID: 0xA1
// Object Name: DrillMobile.cpp

#include "DrillMobile.h"

typedef IMath Math;

void DrillMobile::Create() {
    Enemy::Create();
    this->Active = true;
    this->Priority = false;
    this->W = 32;
...
void DrillMobile::DoExplosionDebris() {
...
void DrillMobile::Update() {
    HandleDamage();
    Object::Update();
}

void DrillMobile::Render(int CamX, int CamY) {
...
int DrillMobile::OnCollisionWithPlayer(int PlayerID, int HitFrom, int Data) {

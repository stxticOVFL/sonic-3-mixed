// Object ID: 0x59
// Object Name: DashTrigger.cpp

#include "DashTrigger.h"

typedef IMath Math;

void DashTrigger::Create() {
    Object::Create();
    Active = true;
    Priority = false;
    W = 32;
...
void DashTrigger::Render(int CamX, int CamY) {
...
int DashTrigger::OnCollisionWithPlayer(int PlayerID, int HitFrom, int Data) {
    int i;
...
int DashTrigger::CustomSolidityCheck(int probeX, int probeY, int PlayerID, int checkJumpThrough) {

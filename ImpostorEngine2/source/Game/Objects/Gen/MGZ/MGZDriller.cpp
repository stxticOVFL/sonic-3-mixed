// Object ID: 0x9E
// Object Name: MGZDriller.cpp

#include "MGZDriller.h"

typedef IMath Math;

void MGZDriller::Create() {
    Enemy::Create();
    this->Active = true;
    this->Priority = false;
    this->W = 32;
...
void MGZDriller::Render(int CamX, int CamY) {
...
int MGZDriller::OnCollisionWithPlayer(int PlayerID, int HitFrom, int Data) {

// Object ID: 0x3B
// Object Name: WaterWall.cpp

#include "WaterWall.h"

typedef IMath Math;

void WaterWall::Create() {
    Object::Create();
    this->Active = true;
    this->Priority = true;
    this->W = 64;
...
void WaterWall::Render(int CamX, int CamY) {
...
int WaterWall::OnCollisionWithPlayer(int PlayerID, int HitFrom, int Data) {

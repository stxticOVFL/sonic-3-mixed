// Object ID: 0x36
// Object Name: BreakableBar.cpp

#include "BreakableBar.h"

typedef IMath Math;

void BreakableBar::Create() {
    Object::Create();
    Active = true;
    Priority = false;
    W = 8;
...
void BreakableBar::Render(int CamX, int CamY) {
    if (Broken) return;

...
void ItemBox::Render(int CamX, int CamY) {
    if (Scene->Thremixed) {
...
int ItemBox::OnBreakHorizontal(int PlayerID, int HitFrom) {
...
int ItemBox::OnBreakVertical(int PlayerID, int HitFrom) {

// Object ID: 0x28
// Object Name: InvisibleSolid.cpp

#include "InvisibleSolid.h"

typedef IMath Math;

void InvisibleSolid::Create() {
    Object::Create();
    Active = true;
    Priority = false;
    Painful = false;
...
void InvisibleSolid::Render(int CamX, int CamY) {
    }

int InvisibleSolid::OnCollisionWithPlayer(int PlayerID, int HitFrom, int Data) {
    if (Painful) {

...
PUBLIC Level_DEZ::Level_DEZ(IApp* app, IGraphics* g, int act) : LevelScene(app, g) {
    ...
    if (Act == 1) {
        ...
        Str_SceneBin = "Stages/DEZ/Scene1.bin";
        Str_TileSprite = "Stages/DEZ/16x16Tiles1.gif";
        //Str_AnimatedSprites = "Sprites/DEZ/AnimatedTiles";
        Str_ObjectsList = "Stages/DEZ/Objects1.bin";
        Str_RingsList = "Stages/DEZ/Rings1.bin";
    }
